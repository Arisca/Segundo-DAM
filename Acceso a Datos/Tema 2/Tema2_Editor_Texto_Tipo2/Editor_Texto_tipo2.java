package Tema2_Editor_Texto_Tipo2;
...
public class Editor_Texto_tipo2 extends JFrame
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					Editor_Texto_tipo2 frame = new Editor_Texto_tipo2();
